...
import 'package:finpayconnect_seller/components/consts.dart';
import 'package:finpayconnect_seller/main.dart';
  ...
  Future<List<LatLng>> getPolylinePoints() async {
    ...
    PolylineResult result = await polylinePoints.getRouteBetweenCoordinates(
      request: PolylineRequest(
        ...
        mode: TravelMode.driving, // Changed 'travelMode' to 'mode'
      ),
